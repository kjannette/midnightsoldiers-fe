    ...
    <div className="tos">
      <div className="tos-container">
        ...
        <section className="tos-section">
          <h2>General Terms</h2>
          <p>
            By accessing and placing an order with midnightsoldiers, you
            ...
            communication between you and midnightsoldiers.
          </p>
          <p>
            Under no circumstances shall midnightsoldiers team be liable for any
            ...
            even if midnightsoldiers team or an authorized representative has
          ...
          <p>
            midnightsoldiers will not be responsible for any outcome that may
        ...
        <section className="tos-section">
          <h2>License</h2>
          <p>
            midnightsoldiers grants you a revocable, non-exclusive,
          ...
          <p>
            ...
            midnightsoldiers (referred to in these Terms & Conditions as "
            midnightsoldiers", "us", "we" or "our"), the provider of the
            midnightsoldiers website and the services accessible from the
            midnightsoldiers website (which are collectively referred to in
            these Terms & Conditions as the " midnightsoldiers Service").
          </p>
          <p>
            ...
            midnightsoldiers Service. In these Terms & Conditions, "you" refers
        ...
        <section className="tos-section">
          ...
          <ul>
            ...
            <li>
              ...
              "us," or "our," it refers to Novodraft, Inc, (407 Lincoln Rd Ste
              6H, PMB 298 Miami Beach, FL 33139 ), that is responsible for your
              information under this Terms & Conditions.
            </li>
            <li>
              <strong>Country:</strong> where midnightsoldiers or the
              owners/founders of midnightsoldiers are based, in this case is
              United States
            </li>
            <li>
              ...
              visit midnightsoldiers and use the services.
            </li>
            <li>
              <strong>Service:</strong> refers to the service provided by
              midnightsoldiers as described in the relative terms (if available)
            ...
            <li>
              <strong>Website:</strong> midnightsoldiers's site, which can be
              accessed via this URL: http://www.midnightsoldiers.com
            </li>
            <li>
              <strong>You:</strong> a person or entity that is registered with
              midnightsoldiers to use the Services.
            </li>
          </ul>
        </section>
        ...
        <section className="tos-section">
          ...
          <ul>
            ...
            <li>
              ...
              notice of copyright or trademark) of midnightsoldiers or its
        ...
        <section className="tos-section">
          ...
          <p>
            Thanks for shopping at midnightsoldiers. We appreciate the fact that
          ...
          <p>
            ...
            apply to transactions at midnightsoldiers. We'll be as brief as our
            attorneys will allow. The main thing to remember is that by placing
            an order or making a purchase at midnightsoldiers, you agree to the
            terms along with midnightsoldiers's Privacy Policy.
          </p>
          <p>
        ...
        <section className="tos-section">
          ...
          <p>
            ...
            (collectively, "Suggestions") provided by you to midnightsoldiers
            with respect to the website shall remain the sole and exclusive
            property of midnightsoldiers.
          </p>
          <p>
            midnightsoldiers shall be free to use, copy, modify, publish, or
        ...
        <section className="tos-section">
          ...
          <p>
            ...
            midnightsoldiers. We are not responsible for the content, accuracy
        ...
        <section className="tos-section">
          <h2>Cookies</h2>
          <p>
            midnightsoldiers uses "Cookies" to identify the areas of our website
        ...
        <section className="tos-section">
          ...
          <p>
            You acknowledge and agree that midnightsoldiers may stop
            (permanently or temporarily) providing the Service (or any features
            within the Service) to you or to users generally at
            midnightsoldiers's sole discretion, without prior notice to you. You
            may stop using the Service at any time. You do not need to
            specifically inform midnightsoldiers when you stop using the
            Service. You acknowledge and agree that if midnightsoldiers disables
        ...
        <section className="tos-section">
          ...
          <p>
            midnightsoldiers reserves the right to modify, suspend or
        ...
        <section className="tos-section">
          ...
          <p>
            midnightsoldiers may from time to time provide enhancements or
          ...
          <p>
            ...
            of the website. You agree that midnightsoldiers has no obligation to
        ...
        <section className="tos-section">
          ...
          <p>
            You acknowledge and agree that midnightsoldiers shall not be
            ...
            decency, quality or any other aspect thereof. midnightsoldiers does
        ...
        <section className="tos-section">
          ...
          <p>
            midnightsoldiers may, in its sole discretion, at any time and for
          ...
          <p>
            ...
            midnightsoldiers, in the event that you fail to comply with any
          ...
          <p>
            ...
            midnightsoldiers's rights or remedies at law or in equity in case of
        ...
        <section className="tos-section">
          ...
          <p>
            You agree to indemnify and hold midnightsoldiers and its parents,
        ...
        <section className="tos-section">
          ...
          <p>
            ...
            extent permitted under applicable law, midnightsoldiers, on its own
            ...
            foregoing, midnightsoldiers provides no warranty or undertaking, and
          ...
          <p>
            Without limiting the foregoing, neither midnightsoldiers nor any
            midnightsoldiers's provider makes any representation or warranty of
            ...
            content, or e-mails sent from or on behalf of midnightsoldiers are
        ...
        <section className="tos-section">
          ...
          <p>
            ...
            liability of midnightsoldiers and any of its suppliers under any
          ...
          <p>
            ...
            midnightsoldiers or its suppliers be liable for any special,
            ...
            for loss of privacy arising out of or in any way related to the use
            ...
            midnightsoldiers or any supplier has been advised of the possibility
        ...
        <section className="tos-section">
          ...
          <p>
            ...
            notices published by midnightsoldiers on the Services, shall
            constitute the entire agreement between you and midnightsoldiers
            ...
            midnightsoldiers's failure to assert any right or provision under
            this Agreement shall not constitute a waiver of such right or
            provision. YOU AND midnightsoldiers AGREE THAT ANY CAUSE OF ACTION
        ...
        <section className="tos-section">
          ...
          <p>
            midnightsoldiers reserves the right, at its sole discretion, to
        ...
        <section className="tos-section">
          ...
          <p>
            ...
            midnightsoldiers regarding your use of the website and supersedes
            all prior and contemporaneous written or oral agreements between you
            and midnightsoldiers.
          </p>
          <p>
            You may be subject to additional terms and conditions that apply
            when you use or purchase other midnightsoldiers's services, which
            midnightsoldiers will provide to you at the time of such use or
            purchase.
          </p>
        </section>
        ...
        <section className="tos-section">
          ...
          <p>
            ...
            arrangement thereof), are owned by midnightsoldiers, its licensors
            ...
            prior written permission of midnightsoldiers, unless and except as
            is expressly provided in these Terms & Conditions. Any unauthorized
        ...
        <section className="tos-section">
          ...
          <p>
            ...
            REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR midnightsoldiers's
            INTELLECTUAL PROPERTY RIGHTS. The term "dispute" means any dispute,
            action, or other controversy between you and midnightsoldiers
        ...
        <section className="tos-section">
          ...
          <p>
            In the event of a dispute, you or midnightsoldiers must give the
            ...
            midnightsoldiers will send any Notice of Dispute to you by mail to
            your address if we have it, or otherwise to your email address. You
            and midnightsoldiers will attempt to resolve any dispute through
            informal negotiation within sixty (60) days from the date the Notice
            of Dispute is sent. After sixty (60) days, you or midnightsoldiers
        ...
        <section className="tos-section">
          ...
          <p>
            If you and midnightsoldiers don't resolve any dispute by informal
        ...
        <section className="tos-section">
          ...
          <p>
            ...
            property of midnightsoldiers without any compensation or credit to
            you whatsoever. midnightsoldiers and its affiliates shall have no
        ...
        <section className="tos-section">
          <h2>Promotions</h2>
          <p>
            midnightsoldiers may, from time to time, include contests,
        ...
        <section className="tos-section">
          ...
          <p>
            ...
            signed by an authorized representative of midnightsoldiers.
            midnightsoldiers will be entitled to injunctive or other equitable
            relief (without the obligations of posting any bond or surety) in
            the event of any breach or anticipatory breach by you.
            midnightsoldiers operates and controls the midnightsoldiers Service
            from its offices in United States. The Service is not intended for
            distribution to or use by any person or entity in any jurisdiction
            or country where such distribution or use would be contrary to law
            or regulation. Accordingly, those persons who choose to access the
            midnightsoldiers Service from other locations do so on their own
            ...
            Conditions (which include and incorporate the midnightsoldiers
            Privacy Policy) contains the entire understanding, and supersedes
            all prior understandings, between you and midnightsoldiers
        ...
        <section className="tos-section">
          <h2>Disclaimer</h2>
          <p>midnightsoldiers is not responsible for any content, code or any other imprecision.</p>
          <p>midnightsoldiers does not provide warranties or guarantees.</p>
          <p>
            In no event shall midnightsoldiers be liable for any special,
          ...
          <p>
            The midnightsoldiers Service and its contents are provided "as is"
            and "as available" without any warranty or representations of any
            kind, whether express or implied. midnightsoldiers is a distributor
            and not a publisher of the content supplied by third parties; as
            such, midnightsoldiers exercises no editorial control over such
            ...
            merchandise provided through or accessible via the midnightsoldiers
            Service. Without limiting the foregoing, midnightsoldiers
            specifically disclaims all warranties and representations in any
            content transmitted on or in connection with the midnightsoldiers
            Service or on sites that may appear as links on the midnightsoldiers
            Service, or in the products provided as a part of, or otherwise in
            connection with, the midnightsoldiers Service, including without
            ...
            oral advice or written information given by midnightsoldiers or any
            ...
            midnightsoldiers does not warrant that the midnightsoldiers Service
        ...
        <section className="tos-section">
          ...
          <ul>
            <li>
              Via this Link:{" "}
              <a href="http://www.midnightsoldiers.com/contact">
                http://www.midnightsoldiers.com/contact
              </a>
            </li>
          </ul>
        </section>
