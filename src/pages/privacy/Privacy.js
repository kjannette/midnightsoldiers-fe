  ...
  return (
    <div className="privacy">
      <div className="privacy-container">
        ...
        <p className="updated-date">Updated at October 11th, 2025</p>

        <section className="privacy-section">
          <p>
            midnightsoldiers ("we," "our," or "us") is committed to protecting
            your privacy. This Privacy Policy explains how your personal
            information is collected, used, and disclosed by midnightsoldiers.
          </p>
          <p>
            ...
            midnightsoldiers. By accessing or using our Service, you signify
            that you have read, understood, and agree to our collection,
            storage, use, and disclosure of your personal information as
            described in this Privacy Policy and our Terms of Service. This
            Privacy Policy was created with Termify.
          </p>
        </section>
        ...
        <section className="privacy-section">
          ...
          <ul>
            ...
            <li>
              ...
              "we," "us," or "our," it refers to Novodraft, Inc, (407 Lincoln Rd
              Ste 6H, 298 Miami Beach, FL 33139 ), that is responsible for your
            ...
            <li>
              ...
              person that signs up to use the midnightsoldiers Service to manage
            ...
            <li>
              ...
              employed by midnightsoldiers or are under contract to perform a
        ...
        <section className="privacy-section">
          <h2>
            When does midnightsoldiers use end user information from third
            parties?
          </h2>
          <p>
            midnightsoldiers will collect End User Data necessary to provide the
            midnightsoldiers services to our customers. End users may
            voluntarily provide us with information they have made available on
            social media websites. If you provide us with any such information,
            we may collect publicly available information from the social media
        ...
        <section className="privacy-section">
          <h2>
            When does midnightsoldiers use customer information from third
            parties?
          </h2>
          <p>
            ...
            interest in becoming a midnightsoldiers customer, we receive
            information from a third party that provides automated fraud
            detection services to midnightsoldiers. We also occasionally collect
        ...
        <section className="privacy-section">
          ...
          <p>
            midnightsoldiers will collect personal information that you submit
        ...
        <section className="privacy-section">
          ...
          <p>
            ...
            midnightsoldiers to you and fulfill the purposes described in this
        ...
        <section className="privacy-section">
          ...
          <p>
            ...
            information you transmit to midnightsoldiers or guarantee that your
        ...
        <section className="privacy-section">
          ...
          <p>
            midnightsoldiers is incorporated in United States. Information
            collected via our website, through direct interactions with you, or
            from use of our help services may be transferred from time to time
            to our offices or personnel, or to third parties, located throughout
            ...
            allowed by applicable law, by using any of the above, you
        ...
        <section className="privacy-section">
          <h2>
            Is the information collected through the midnightsoldiers Service
            secure?
          </h2>
          <p>
        ...
        <section className="privacy-section">
          ...
          <p>
            ...
            information midnightsoldiers collects depend on your relationship
            with midnightsoldiers. Personnel may update or correct their
        ...
        <section className="privacy-section">
          <h2>Personnel</h2>
          <p>
            If you are a midnightsoldiers worker or applicant, we collect
        ...
        <section className="privacy-section">
          ...
          <p>
            ...
            all of the assets of midnightsoldiers or any of its Corporate
            Affiliates (as defined herein), or that portion of midnightsoldiers
            or any of its Corporate Affiliates to which the Service relates, or
            in the event that we discontinue our business or file a petition or
        ...
        <section className="privacy-section">
          ...
          <p>
            ...
            control with midnightsoldiers, whether by ownership or otherwise.
        ...
        <section className="privacy-section">
          ...
          <p>
            By using midnightsoldiers or contacting us directly, you signify
        ...
        <section className="privacy-section">
          ...
          <p>
            ...
            it's being used. By using our midnightsoldiers, registering an
        ...
        <section className="privacy-section">
          ...
          <p>
            ...
            third party sites. midnightsoldiers does not make any representation
            as to the accuracy or suitability of any of the information
            contained in those advertisements or sites and does not accept any
          ...
          <p>
            Advertising keeps midnightsoldiers and many of the websites and
          ...
          <p>
            ...
            midnightsoldiers of the third party sites, goods or services.
            midnightsoldiers takes no responsibility for the content of any of
            the ads, promises made, or the quality/reliability of the products
        ...
        <section className="privacy-section">
          ...
          <p>
            ...
            the right thing to do. At midnightsoldiers we strongly believe that
        ...
        <section className="privacy-section">
          ...
          <p>
            ...
            rights requirements of GDPR. midnightsoldiers processes or stores
            all personal data in fully vetted, DPA compliant vendors. We do
            store all conversation and personal data for up to 6 years unless
            your account is deleted. In which case, we dispose of all data in
